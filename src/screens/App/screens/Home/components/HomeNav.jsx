...
function HomeNav() {
  return (
    <div className="flex flex-col md:flex-row justify-between w-full bg-gradient-to-br from-accent via-accent-tin to-accent-tone py-3 md:py-0 px-3 sm:px-10 lg:px-16 gap-y-3 md:gap-x-10 2xl:gap-x-80">
      {/* logo */}
