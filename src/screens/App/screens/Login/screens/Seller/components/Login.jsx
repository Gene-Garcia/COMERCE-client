...
function Login() {
  return (
    <div className="h-screen bg-gradient-to-bl from-accent via-accent-tone to-accent-tint flex items-center justify-center py-14 xs:py-0 px-2.5 xs:px-3 sm:px-0">
