...
const Login = () => {
  return (
    ...
    >
      <div
        className="w-11/12 sm:w-4/5 md:w-seventy lg:4/6 xl:w-fiftyfive h-max 
...
const Logo = () => {
  return (
    <Link to="/" className="flex flex-row items-start gap-3 md:gap-4">
      ...
      <div>
        <h2
          className="font-mono text-my-accent
          leading-none
        text-xl md:text-2xl xl:text-3xl"
        >
          COMERCE
        </h2>
        <p className="-mt-0.5 sm:-mt-1 md:-mt-2 font-medium text-my-accent text-md sm:text-lg md:text-xl">
          express
        </p>
      </div>
    </Link>
