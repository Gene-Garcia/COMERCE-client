...
function ProductInventories() {
  const { selected, products } = useManageInventory();
  ...
  return (
    <div className="bg-my-white-tint rounded">
      ...
      >
        <p className="font-semibold text-lg">iPhone 13 Pro 1TB</p>
        ...
        <div className="inline-flex gap-2">
          <div className="text-right">
            ...
            <p className="-mt-1.5 text-red-500 text-md font-medium">400</p>
          </div>
          ...
          <div className="text-right">
            ...
            <p className="-mt-1.5 text-black text-md font-medium">400</p>
          </div>
        </div>
      </div>
      ...
      >
        <div className="inline-flex gap-10">
          <div className="text-center">
            ...
            <p className="text-red-500 text-lg font-medium">400</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-black text-lg font-medium">400</p>
          </div>
        </div>
      </div>
    </div>
